...
export { getAllTanaman, getTanamanById, addTanaman, updateTanaman, deleteTanaman };
...
// const updateTanaman = async (id_tanaman, nama_tanaman, deskripsi_tanaman, foto_tanaman) => {
//     return new Promise((resolve, reject) => {
//         db.query('UPDATE tanaman SET nama_tanaman = ?, deskripsi_tanaman = ?, foto_tanaman = ? WHERE id_tanaman = ?', [nama_tanaman, deskripsi_tanaman, foto_tanaman, id_tanaman], (err, results) => {
//             if (err) {
//                 return reject(err);
//             }
//             resolve(results);
